...
(function() {
    ...
    // Make the native Clear button default the Date to today and keep the Store
    // set to 071 - Sharonville instead of blanking them.
