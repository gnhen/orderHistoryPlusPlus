...
// @version      1.8.0
// @description  Restored summary table logic + 3D Printing Highlights + Department Settings (GS/Systems/BYO) + Perfect Nav Button Alignment + Auto Hours Worked (EST): live for today / first->last sale for past days + Last Sale time + Sales Person quick-pick dropdown + Monthly Sales nav button (between PowerSpec/CTO Lookup and OrderHistory++) + removes dead Product Reservation nav item
// @author       grant
// @match        */Sales/Retail*
// @grant        none
// ==/UserScript==
