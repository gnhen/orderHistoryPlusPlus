// ==UserScript==
// @name         Commission Calc - Manual Trigger (Fixed Summary)
// @namespace    http://tampermonkey.net/
// @version      1.3.0
// @description  Restored summary table logic + 3D Printing Highlights + Department Settings (GS/Systems/BYO)
// @author       grant
// @match        */Sales/Retail*
// @grant        none
// ==/UserScript==
                ...
                for (let txId in transactionIslands) {
                    ...
                    for (let i = 0; i < items.length; i++) {
                        if (i === keyItemIndex) {
                            ...
                            calculatedCommissionTotal += items[i].totalVal * 0.02;  // 2.0% Attach Item Rate
                        }
                    }
                }
            }
